...
const Chef = () => {
    ...
    return (
        <div>
            ...
            <div className="chefs grid md:grid-cols-3 p-2 mb-8">
                {
                    chefsData.map((chef) => (
                        <div key={chef.id} className="max-w-sm p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <LazyLoad height={300} width={350}>
                                <img src={chef.image} className='w-[300px] h-[300px] mx-auto' alt="" />
                            </LazyLoad>
                            <div className='text-center'>
                                <h5 className="mb-4 mt-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{chef.name}</h5>
